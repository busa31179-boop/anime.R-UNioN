document.addEventListener("DOMContentLoaded", () => {
    ...
    const charactersData = {
        protagonists: [
            ...
            { id: "karion", name: "カリオン", role: "大賢者", cv: "早瀬 壮太", image: "images/characters/karion.png", desc: "魔法界ではその名を知らぬ者はいない大賢者。聖魔法と闇魔法の両方を操る稀有な才能を持ち、知識と実力を兼ね備えた存在。ライオネルにその力を見込まれ、勇者一行に加わり、旅路で知恵と魔法の力を仲間たちに与え続ける。" },
            { id: "raven", name: "レイブン", role: "スナイパー", cv: "朝倉 凪", image: "images/characters/sara.png", desc: "元々は無所属の傭兵として名を馳せた孤高の狙撃手。その銃弾は百発百中で、狙撃時に瞳が桜色に輝くことから「桜眼の狙撃手」と呼ばれる。冷静沈着で任務に迷いはなく、仲間を守るためなら孤独な戦場でもひたすら標的を射抜く。" },
            { id: "zenon", name: "ゼノン", role: "錬金術師", cv: "鈴木 悠真", image: "images/characters/zenon.png", desc: "古代に禁忌とされた呪いの錬金術すら操ることのできる稀代の錬金術師。好奇心旺盛で、常に新たな知識と可能性を求める冒険者でもある。かつて禁忌錬金に手を染めたことから牢獄に幽閉されていた過去を持ち、自身の知識欲を満たすために勇者一行とともに旅をしていた。自由奔放な性格。" },
            { id: "nox", name: "ノクス", role: "アサシン", cv: "中村 涼", image: "images/characters/nox.png", desc: "宵闇に現れる漆黒の暗殺者。報酬さえ得られればどんな任務も冷徹に遂行する冷静さを持つ。かつて魔族から依頼されたライオネル暗殺に失敗したことで、彼の強さの根源に強い興味を抱き、以来その力を知るために共に旅をすることとなった。影のように静かでありながら、仲間の旅路に思わぬ影響を与える存在。同じ暗殺者としてシンゲツをライバル視している。" },
            ...
            { id: "shingetsu", name: "シンゲツ", role: "月鬼", cv: "佐藤 拓真", image: "images/characters/sin.png", desc: "月夜に現れる暗殺者。その姿を直接見た者はなく、「月夜の鬼（月鬼）」として恐れられていた。ノクスとは異なり、正義の名のもとに弱き者を守る依頼しか請け負わない孤高の暗殺者。貧困に苦しむ人々を助けられるならばと、ライオネル一行に加わる。正義感ゆえにノクスとは主義の違いから衝突することも多い。" },
